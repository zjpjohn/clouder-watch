 ...
 *
 *****************************************************************************/
package com.hoperun.records.service;
...
import com.hoperun.records.activity.IncomingActivity;
...
public class MessageListenerService extends Service implements OnConnectionFailedListener, ConnectionCallbacks,
	...
	public void onConnectionFailed(ConnectionResult connectionResult) {
		Log.e(TAG, "CMS服务连接失败或者断开连接 " + connectionResult.toString());
	}
