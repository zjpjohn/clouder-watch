 ...
 */
public class RecordSimpleAdapter extends BaseAdapter {
    private List<Map<String, Object>> mData;
    private LayoutInflater mInflater;

    public RecordSimpleAdapter(Context context, List<Map<String, Object>> mData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.info = (TextView) convertView.findViewById(R.id.date);
...
//        holder.img.setBackgroundResource((Integer) mData.get(position).get("img"));
        ...
        holder.info.setText((String) mData.get(position).get("date"));
