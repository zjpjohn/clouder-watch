...
public class WearableAdapter extends MmsClient<IBLECentralService> {
	...
	public void getDataItems(final WearableResult<DataItemBuffer> wearableResult) throws RemoteException {
		getService().getDataItems(new WearableCallback(this.mContext) {

			@Override
			public void setDataHolderRsp(DataHolder dataHolder) throws RemoteException {
				Log.i(TAG, "getDataItems -> " + dataHolder.toString());
	...
	public void getFdForAsset(final WearableResult<DataApi.GetFdForAssetResult> wearableResult, Asset asset)
		...
		getService().getFdForAsset(new WearableCallback(this.mContext) {
			...
			public void setGetFdForAssetRsp(GetFdForAssetResponse getFdForAssetResponse) throws RemoteException {
				Log.i(TAG, "getFdForAsset -> " + getFdForAssetResponse.toString());
