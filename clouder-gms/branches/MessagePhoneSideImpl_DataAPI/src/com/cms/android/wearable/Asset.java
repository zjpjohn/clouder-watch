	...
	public boolean equals(Object obj) {
		...
		if (!bool) {
			...
			if (bool) {
				...
				bool = (equals(this.versionCode, asset.versionCode)) && (equals(this.fd, asset.fd))
						&& (equals(this.digest, asset.digest))
						&& (equals(this.uri, asset.uri) && equals(this.data, asset.data));
				Log.d("spencer",
						"equals--->" + equals(this.versionCode, asset.versionCode) + " " + equals(this.fd, asset.fd)
								+ " " + equals(this.digest, asset.digest) + " " + equals(this.uri, asset.uri) + " "
								+ equals(this.data, asset.data));
			}
		}
