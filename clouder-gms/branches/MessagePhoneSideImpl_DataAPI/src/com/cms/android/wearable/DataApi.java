...
public abstract interface DataApi {
	...
	public abstract PendingResult<DataItemResult> putDataItem(MobvoiApiClient mobvoiApiClient,
			PutDataRequest putDataRequest);

	public abstract PendingResult<DataItemBuffer> getDataItems(MobvoiApiClient mobvoiApiClient);

	public abstract PendingResult<GetFdForAssetResult> getFdForAsset(MobvoiApiClient mobvoiApiClient, Asset asset);
