 ...
 * 
 */
public class WearableAdapter extends MmsClient<IBLECentralService> {
	...
	@Override
	protected IBLECentralService getService(IBinder iBinder) {
		return IBLECentralService.Stub.asInterface(iBinder);
	}
	...
	public void sendMessage(final WearableResult<SendMessageResult> wearableResult, String node, String path,
		...
		Log.d(TAG, String.format("Send message -> node = %s ,path = %s , length = %d.", node, path, data == null ? 0
				: data.length));
		getService().sendMessage(new WearableCallback() {
	...
	public void addListener(final WearableResult<Status> wearableResult, IWearableListener listener)
		...
		getService().addListener(new WearableCallback() {
	...
	protected String getStartServiceAction() {
		return "com.hoperun.ble.central.service";
		// return "com.cms.android.wearable.BIND";
	}

	@Override
	protected void onInit(IBinder iBinder) {
		Log.d(TAG, "onInit...");
		setService(this, IBLECentralService.Stub.asInterface(iBinder));
		// try {
	...
	public void addNodeListener(final WearableResult<Status> wearableResult, IWearableListener listener)
			throws RemoteException {
		Log.i(TAG, "getService addNodeListener");
	...
	public void removeNodeListener(final WearableResult<Status> wearableResult, IWearableListener listener)
			throws RemoteException {
		Log.i(TAG, "getService removeNodeListener");
