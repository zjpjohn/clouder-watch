...
public class GetFdForAssetResponse implements SafeParcelable {
	public static final Parcelable.Creator<GetFdForAssetResponse> CREATOR = new GetFdForAssetResponseCreator();
	...
	public static class GetFdForAssetResponseCreator implements Parcelable.Creator<GetFdForAssetResponse> {
