...
interface IBLEPeripheralService {
  ...
  void addListener(in IBLEPeripheralCallback callback, in IWearableListener listener,in String node);
   
  void removeListener(IBLEPeripheralCallback callback, IWearableListener listener, String node);
  
  void addNodeListener(in IBLEPeripheralCallback callback, in IWearableListener listener);
  
  void removeNodeListener(in IBLEPeripheralCallback callback, in IWearableListener listener);
