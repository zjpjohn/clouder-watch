...
public class MainActivity extends Activity implements OnConnectionFailedListener, ConnectionCallbacks,
	...
	private void getNodes() {
		NodeApi.GetConnectedNodesResult result = (GetConnectedNodesResult) Wearable.NodeApi.getConnectedNodes(mobvoiApiClient).await();
		...
		for (Node node : nodes) {
			...
			Wearable.MessageApi.sendMessage(mobvoiApiClient, node.getId(), "/test", content.getBytes())
