...
public class DataItemParcelable implements Parcelable, DataItem {
	public static final Creator<DataItemParcelable> CREATOR = new DataItemCreator();
	...
	public String toString() {
		...
		if (this.data == null) {
			...
			obj = Integer.valueOf(this.data.length);
		}
		sb.append(obj);
	...
	public static class DataItemCreator implements Creator<DataItemParcelable> {
