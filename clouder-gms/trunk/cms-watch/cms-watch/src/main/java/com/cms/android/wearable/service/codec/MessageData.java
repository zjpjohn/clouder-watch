...
public class MessageData extends Parser {
	...
	public MessageData(String deviceNo, byte[] command, byte[] data, long timeStamp, String packageName, String path, String nodeId) {
		super();
		this.deviceNo = deviceNo;
	...
	public String toString() {
		return "MessageData [uuid=" + uuid + ", deviceNo=" + deviceNo + ", command=" + Arrays.toString(command)
				+ ", data size=" + (data == null ? 0 : data.length) + ", timeStamp=" + timeStamp + ", packageName="
