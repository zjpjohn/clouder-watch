...
public class DataItemAssetParcelable implements SafeParcelable, DataItemAsset {
	public static final Creator<DataItemAssetParcelable> CREATOR = new DataItemAssetCreator();
	...
	public static class DataItemAssetCreator implements Creator<DataItemAssetParcelable> {
