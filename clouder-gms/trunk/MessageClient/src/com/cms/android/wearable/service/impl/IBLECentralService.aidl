...
interface IBLECentralService {
  ...
  void addListener(in IBLECentralCallback callback, in IWearableListener listener);
  
  void removeListener(IBLECentralCallback callback, IWearableListener listener);
