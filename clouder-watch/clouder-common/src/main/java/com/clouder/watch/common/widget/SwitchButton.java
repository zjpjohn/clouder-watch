...
public class SwitchButton extends View {
    ...
    private void changeStatus() {
        if (mStatus == STATUS.OFF) {
            mStatus = STATUS.ON;
            if (mListener != null) {
                mListener.onChange(this, true);
            }
        } else {
            mStatus = STATUS.OFF;
            if (mListener != null) {
                mListener.onChange(this, false);
            }
        }
    }
    ...
    public void setChecked(boolean checked) {
        setStatus(checked ? STATUS.ON : STATUS.OFF);
    }
    ...
    private void setStatus(STATUS status) {
        ...
        mStatus = status;
        /*if (mListener != null) {
            mListener.onChange(this, status == STATUS.ON ? true : false);
        }*/
    ...
    public boolean isChecked() {
        return mStatus == STATUS.ON;
    }

    public interface OnStatusChangeListener {
        void onChange(SwitchButton button, boolean checked);
    }
}