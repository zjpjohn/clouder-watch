...
public class SwipeRightLayout extends FrameLayout {
    private static final String TAG = SwipeRightLayout.class.getSimpleName();
    ...
    public SwipeRightLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeRightLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (once && (deltaX > mTouchSlop && deltaX > Math.abs(deltaY))) {
                    once = false;
                    isSilding = true;
                    return true;
                }
