...
public class ChangePasswordActivity extends Activity implements View.OnClickListener {
    ...
    public static final int SECONDPASSWORD = 2;
            ...
            case R.id.textOk:
                ...
                if (flag == SECONDPASSWORD) {
                    if (edtPswOne.getText().equals("")) {
                        ...
                        intent.putExtra("password", passWordSecond);
                        Log.d(TAG, "修改后密码：" + passWordSecond);
                        setResult(1, intent);
                        finish();
                    ...
                    if (edtPswOne.getText().equals("")) {
                        ...
                        if (passWordFirst.equalsIgnoreCase(passWord) == false) {
                            textNotify.setText(R.string.activity_changepsw_input_password_new_agin);
                            flag = SECONDPASSWORD;
                            setText();
                        } else {
